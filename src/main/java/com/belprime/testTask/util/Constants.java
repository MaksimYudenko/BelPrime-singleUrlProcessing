...
public class Constants {
    ...
    public static final Integer LINKS_QUANTITY = 30;
    public static final String IGNORED_SITE = "linkedin";
    public static final Integer BQ_CAPACITY = 100;
    public static final Integer POLL_TIMEOUT = 5;
    static final String WELCOME_PHRASE = "Type phrase to search (as many as you'd like):";
